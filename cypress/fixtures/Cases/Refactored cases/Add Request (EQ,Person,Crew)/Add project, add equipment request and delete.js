/**
 * Add Project, Add Equipment Request and Delete Test
 * Tests the complete flow: create project, add equipment request, delete request, and delete project
 */

import { AddRequestHelpers } from './addRequestHelpers.js';
import { generateProjectName } from './addRequestConfig.js';

describe('Add Project, Equipment Request and Delete Test Suite', function () {
    before(function () {
    ...
    it('should create project, add equipment request, delete request and delete project', function () {
        ...
        // Step 4: Delete equipment request
        helpers.deleteEquipmentRequest();
