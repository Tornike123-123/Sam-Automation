...
describe('Add booking in "Hr Planner"', () => {
    ...
    it('', () => {
        ...
        cy.wait(7000)
        //FIRST BOOKING
        cy.get(':nth-child(2) > .mbsc-timeline-events > .mbsc-timeline-events-track > .mbsc-ltr > div.ng-star-inserted > sam-hr-timeline-event.ng-star-inserted > .timeline').rightclick()
        //booking edit
        ...
        cy.wait(3000)
        //first person
        cy.get(':nth-child(2) > .mbsc-timeline-resource-title > sam-person-card.ng-star-inserted > .person-card > .person-card__header > .person-card__header-title > .person-card__header-title-txt').invoke('removeAttr', 'target').click({force : true});
        cy.wait(7000)
        ...
        cy.get('img[alt="delete"]').click().should('be.visible');
        cy.get('.filled').click();
